...
export default function GoogleLoginButton({ handelGoogleLogin,title }: GoogleProps) {
    ...
    return (
        ...
        <motion.div
            ...
            onClick={() => login()}
            whileTap={{ scale: 0.98 }}
            className="w-full border cursor-pointer border-white/20 hover:border-white/30 text-slate-700 font-medium py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50"
        >
